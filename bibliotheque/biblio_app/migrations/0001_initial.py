    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ida', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='biblio_app.adherent')),
            ],
        ),
        migrations.CreateModel(
            name='AdminSup',
            fields=[
                ('personne_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('adherant_admin', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='adherant_admin', to='biblio_app.adherent')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_utilisateur', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='biblio_app.utilisateur')),
            ],
        ),
        migrations.CreateModel(
            name='Emprunter',
            fields=[
                ...
                ('ouvrage', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='biblio_app.ouvrage')),
                ('adherant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='biblio_app.adherent')),
